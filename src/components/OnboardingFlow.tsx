          ...
          <div className="text-center space-y-6" style={{ fontFamily: "Noto Sans, sans-serif" }}>
            ...
            <div>
              ...
              <p className="text-stone-600" style={{ fontFamily: "Noto Sans, sans-serif" }}>
                Let's set up your cloud-powered voice dictation in just a few simple steps.
              </p>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Cloud Processing Setup</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-amber-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-amber-800">
                OpenWhispr only uses these permissions for dictation. Your voice is sent to OpenAI's servers for transcription.
              </p>
            </div>
          </div>
        );
          ...
          <div className="space-y-6" style={{ fontFamily: "Noto Sans, sans-serif" }}>
            ...
            <div className="space-y-6">
              <div className="bg-blue-50/50 p-6 rounded-lg border border-blue-200/60">
                <h3 className="font-semibold text-blue-900 mb-3" style={{ fontFamily: "Noto Sans, sans-serif" }}>
              ...
              <div className="bg-green-50/50 p-4 rounded-lg border border-green-200/60">
                <h4 className="font-medium text-green-900 mb-2" style={{ fontFamily: "Noto Sans, sans-serif" }}>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 p-4 bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-xl">
              ...
              <ul className="text-sm text-purple-800 space-y-1">
                <li>• Say "Hey {agentName || "Agent"}, write a formal email" for specific instructions</li>
